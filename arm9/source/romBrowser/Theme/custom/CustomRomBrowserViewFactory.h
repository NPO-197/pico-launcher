...
public:
    ...
    {
        return SharedPtr<CustomIconGridItemView>::MakeShared(_gridCellTexVramOffset, _gridCellPlttVramOffset,
    ...
    {
        return SharedPtr<CustomBannerListItemView>::MakeShared(_materialColorScheme, _fontRepository,
